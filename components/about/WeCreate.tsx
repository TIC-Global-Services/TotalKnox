      ...
      <div ref={containerRef} className="w-full px-6 md:px-10">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          <div className="md:col-span-3">
            <span className="inline-flex items-center gap-2 text-xl uppercase text-black -mt-1 md:-mt-2 font-display tracking-tight"><span className="inline-block h-2.5 w-2.5 bg-black" />We Create</span>
          </div>
          <div className="md:col-span-9">
            <p className="text-3xl md:text-[2.5rem] uppercase leading-[1] tracking-tight mt-10">
        ...
        <div className="mt-16 flex flex-col items-center gap-6 md:flex-row md:justify-center md:gap-10">
          <div ref={leftCardRef} className="overflow-hidden rounded-xl bg-black w-[320px] h-[500px] shrink-0 mt-10">
            <Image
          ...
          <div ref={rightCardRef} className="overflow-hidden rounded-xl bg-black w-[320px] h-[500px] shrink-0">
            <Image
