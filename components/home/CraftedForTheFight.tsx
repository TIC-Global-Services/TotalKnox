    ...
    <section className="bg-bone py-16 md:py-28">
      <div className="mx-auto w-full max-w-[1400px] px-6 md:px-10 grid grid-cols-1 items-center gap-10 md:grid-cols-2 md:gap-16">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg leading-tight text-black md:text-base">
          ...
          <a href="#" className="inline-flex items-center justify-center rounded-2xl px-7 py-3.5 text-base font-semibold uppercase tracking-[1] transition bg-black text-white hover:bg-black mt-8">
            Our Philosophy
          </a>
        </div>
      </div>
